...
import { Accounts, FAQ, Purchases } from '../../features'
...
export default function AccountsPage() {
  return (
    <>
      <Head>
        <title>Purchases | DeRafl - Decentralized NFT Raffles</title>
        ...
        <meta property="og:title" content="Purchases | DeRafl - Decentralized NFT Raffles"/>
