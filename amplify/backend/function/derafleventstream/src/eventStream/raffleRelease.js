...
exports.handleRaffleRelease = async (log, txId, timestamp, chainId) => {
    ...
    await StatService_1.incrementRoyalties(parseFloat(utils_1.formatEther(log.royaltiesPaid.toString())), chainId);
    await StatService_1.incrementEth(parseFloat(utils_1.formatEther(log.ethPaid.toString())), chainId);
    try {
